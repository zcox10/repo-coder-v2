    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if not large_grad:
                large_grad = deepcopy(
                    small_grad
                )  # [small_grad_ + 0. for small_grad_ in small_grad]
            else:
            ...
            if max_eig == None:
                ...
                if eig <= max_eig / decay_ratio:
                    ...
                    optimizer = exp_lr_scheduler(
                        optimizer, decay_ratio=large_ratio / prev_ratio
                    )
        ...
        if print_flag:
            ...
            print(
                "\n Eig %f Max Eig %f Batch size %d"
                % (eig, max_eig, batch_size * large_ratio)
            )
