...
class DomainNet(ImageList):
    ...
    download_list = [
        (
            "image_list",
            "image_list.zip",
            "https://cloud.tsinghua.edu.cn/f/73489ae10aea45d58194/?dl=1",
        ),
        (
            "clipart",
            "clipart.zip",
    ...
    def __init__(
        ...
        **kwargs,
        ...
        data_list_file = os.path.join(
            root, "image_list", "{}_{}.txt".format(self.image_list[task], phase)
        )
        ...
        super(DomainNet, self).__init__(
            root, DomainNet.CLASSES, data_list_file=data_list_file, **kwargs
        )
