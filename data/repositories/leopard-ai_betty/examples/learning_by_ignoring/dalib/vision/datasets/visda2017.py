...
class VisDA2017(ImageList):
    ...
    image_list = {
        ...
        "T_train": "image_list/train_train.txt",
        "T_val": "image_list/train_val.txt",
        "T_test": "image_list/train_test.txt",
        "V_train": "image_list/val_train.txt",
        "V_val": "image_list/val_val.txt",
        "V_test": "image_list/val_test.txt",
